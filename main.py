...
hour_entry = tk.Entry(root, font = ("Arial", 12), textvariable = hour, width = 5, bg = "#4C4C4C", fg = "#ffa500")
hour_entry.place(x = 80, y = 40)

minute_entry = tk.Entry(root, font = ("Arial", 12), textvariable = minute, width = 5, bg = "#4C4C4C", fg = "#ffa500")
minute_entry.place(x = 130, y = 40)

second_entry = tk.Entry(root, font = ("Arial", 12), textvariable = second, width = 5, bg = "#4C4C4C", fg = "#ffa500")
